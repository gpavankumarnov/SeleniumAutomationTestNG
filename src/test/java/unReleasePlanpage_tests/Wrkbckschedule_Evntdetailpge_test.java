...
public class Wrkbckschedule_Evntdetailpge_test extends Baseclass{
	...
	Wrkbackschedule_Eventdetailpage eventdetail;
	
	public Wrkbckschedule_Evntdetailpge_test() {
		super();
	}
	...
	public void setUp() throws InterruptedException {
		...
		eventdetail = new Wrkbackschedule_Eventdetailpage();
	...
	@Test(priority=1)
	public void Verifyacitvitytitle() throws InterruptedException {
		wrkbcksdule.datechnge();
		wrkbcksdule.addevent();
		eventdetail.eventformfill();
		eventdetail.Plndstartdate();
		//eventdetail.environmentdd();
		eventdetail.Plndenddate();
		eventdetail.wrkbackschedulenavigateback();
	}
